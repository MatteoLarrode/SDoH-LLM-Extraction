...
def main(args):
    ...
    train_dataset = prepare_multilabel_dataset(args.train_data_file)
    val_dataset = prepare_multilabel_dataset(args.val_data_file)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fine-tune LLaMA-8b-Instruct for multi-label SDoH classification.")
