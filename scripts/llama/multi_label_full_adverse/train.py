...
from scripts.llama.multi_label_full_adverse.prepare_dataset import prepare_adverse_only_dataset
...
def main(args):
    ...
    model_output_dir = os.path.join("results/model_training/llama_lora_multi_label_full_adverse", output_dir_name)
